...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/trame-router-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/trame-router-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add trame-router
# for installing globally
pixi global install trame-router
```
...
It is possible to list all of the versions of `trame-router` available on your platform:
...
```
pixi search trame-router --channel conda-forge
```
